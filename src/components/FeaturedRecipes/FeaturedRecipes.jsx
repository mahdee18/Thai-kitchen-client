            ...
            <div className="flex flex-col items-center justify-center py-8 ">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-screen-xl">
                    ...
                    <div className="bg-purple-300 shadow-lg rounded-lg overflow-hidden">
                        ...
                        />
                        <div className="p-4">
                            <h3 className="text-gray-900 font-bold text-xl mb-2">Green Curry</h3>
                            <p className="text-gray-600 mb-4">A delicious Thai curry made with coconut milk, vegetables, and chicken.</p>
                        </div>
                    </div>
                    ...
                    <div className="bg-purple-300 shadow-lg rounded-lg overflow-hidden">
                        ...
                        <div className="p-4">
                            ...
                            <p className="text-gray-600 mb-4">A classic Thai dish made with stir-fried noodles, vegetables, and peanuts.</p>
                        </div>
                    </div>
                    ...
                    <div className="bg-purple-300 shadow-lg rounded-lg overflow-hidden">
                        ...
                        />
                        <div className="p-4">
                            <h3 className="text-gray-900 font-bold text-xl mb-2">Tom Yum Soup</h3>
                            <p className="text-gray-600 mb-4">A hot and sour soup made with shrimp, lemongrass, and chili paste.</p>
                        </div>
                    </div>
                </div>
            </div>
